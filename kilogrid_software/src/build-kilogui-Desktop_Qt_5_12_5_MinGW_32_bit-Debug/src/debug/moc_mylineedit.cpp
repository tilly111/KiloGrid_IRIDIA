...
#include "../../../KiloGUI/src/mylineedit.h"
...
QT_MOC_LITERAL(1, 11, 14), // "myValueChanged"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "MyLineEdit\0myValueChanged\0"
};
...
void MyLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLineEdit::myValueChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyLineEdit::myValueChanged()
{
